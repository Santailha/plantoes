...
auth.onAuthStateChanged(async (user) => {
    if (user) {
        ...
        if (userDoc.exists) {
            ...
            // Bloqueia a recepção de acessar esta página
...
function initializeApp(user, userRole) {
    ...
    async function handleSaveScale(e) {
        ...
        proposedChanges.tipoPlantao = tipoPlantaoSelecionado; // Store for logging
